...
(function(my) {
    my.extend({
        myvali: function(id) {
            ...
            var mclass = $.extend({},
            myobj, id);
            var myVali = $(mclass.myVali),
            myform = $(mclass.myform),
            mybtn = $(mclass.mybtn);
            var p = $("<p style=" + "font-size:12px;padding-top:2px;display:inline;" + "></p>");
            myform.find(myVali).append(p);
            var Required = $(mclass.Required),
            RequiredTps = $(mclass.RequiredTps),
            Requireds = $(mclass.Requireds),
            reqtps = $(mclass.reqtps),
            Reqlength = $(mclass.Reqlength),
            ReqlengthTps = $(mclass.ReqlengthTps),
            RequiredsTps = $(mclass.RequiredsTps),
            myname1 = $(mclass.myName),
            myname2 = $(mclass.myName2),
            myphone = $(mclass.myPhone),
            myphone1 = $(mclass.myPhone1),
            myCard = $(mclass.myCard),
            isPhoneCode = $(Number(mclass.isPhoneCode)),
            phoneCodeBtn = $(mclass.phoneCodeBtn),
            count = $(mclass.count),
            codeBtnCol1 = $(mclass.codeBtnCol1),
            codeBtnCol2 = $(mclass.codeBtnCol2),
            isPhoneCodeUrl = $(mclass.isPhoneCodeUrl),
            isPhoneCodeType = $(mclass.isPhoneCodeType),
            isPhoneCodeDType = $(mclass.isPhoneCodeDType),
            phoneCodeInput = $(mclass.phoneCodeInput),
            phoneCodeInputUrl = $(mclass.phoneCodeInputUrl),
            phoneCodeInputType = $(mclass.phoneCodeInputType),
            phoneCodeInputDType = $(mclass.phoneCodeInputDType),
            mymailbox = $(mclass.myMailbox),
            mailboxIsServer = $(Number(mclass.mailboxIsServer)),
            mailboxIsServerUrl = $(mclass.mailboxIsServerUrl),
            mailboxIsServerType = $(mclass.mailboxIsServerType),
            mailboxIsServerDType = $(mclass.mailboxIsServerDType),
            mypassword = $(mclass.myPassword),
            mypasswords = $(mclass.myConfirmPassword),
            phoneIsServer = $(Number(mclass.phoneIsServer)),
            phoneIsServerUrl = $(mclass.phoneIsServerUrl),
            phoneIsServerType = $(mclass.phoneIsServerType),
            phoneIsServerDType = $(mclass.phoneIsServerDType),
            phoneIsServer1 = $(Number(mclass.phoneIsServer1)),
            phoneIsServerUrl1 = $(mclass.phoneIsServerUrl1),
            phoneIsServerType1 = $(mclass.phoneIsServerType1),
            phoneIsServerDType1 = $(mclass.phoneIsServerDType1),
            myCode = $(mclass.myCode),
            CodeIsServerUrl = $(mclass.CodeIsServerUrl),
            CodeIsServerType = $(mclass.CodeIsServerType),
            CodeIsServerDType = $(mclass.CodeIsServerDType),
            PwdStrong = $(Number(mclass.PwdStrong)),
            isStrongTps = $(mclass.isStrongTps),
            NameMinLength = $(mclass.myNameMinLength),
            NameMaxLength = $(mclass.myNameMaxLength),
            NameMinLength2 = $(mclass.myNameMinLength2),
            NameMaxLength2 = $(mclass.myNameMaxLength2),
            PasswordMinLength = $(mclass.myPasswordMinLength),
            PasswordMaxLength = $(mclass.myPasswordMaxLength),
            corrCol = $(mclass.corrCol),
            errCol = $(mclass.errCol),
            nameIsserver = $(Number(mclass.nameIsserver)),
            nameIsserverUrl = $(mclass.nameIsserverUrl),
            nameIsServerType = $(mclass.nameIsServerType),
            nameIsServerDType = $(mclass.nameIsServerDType),
            isMyCode = $(mclass.isMyCode),
            ...
            var valiform = {
                ...
                vphone: function() {
                    var strphone = /^1[3|4|5|7|8|9][0-9]{9}$/;
                    if ($(this).val() == "") {
                        $(this).siblings("p").html("请输入手机号").removeAttr("class").css({
                            "color": errCol[0]
                        })
                    } else if (!strphone.test($(this).val())) {
                        $(this).siblings("p").html("请输入11位正确的手机号").removeAttr("class").css({
                            "color": errCol[0]
                        });
                        if (isPhoneCode[0] == 1) {
                            if (isMyCode[0] == 1) {
                        ...
                        if (phoneIsServer[0] == 1) {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data == 1) {
                                        $this.siblings("p").html("手机号可以注册").attr({
                                            "class": "correct"
                                        }).css({
                                            "color": corrCol[0]
                                        });
                                        ...
                                        $this.siblings("p").html("手机号已被注册").removeAttr("class").css({
                                            "color": errCol[0]
                                        });
                                        if (isPhoneCode[0] == 1) {
                                            myform.find(phoneCodeBtn).css("color", codeBtnCol1[0]).attr("disabled", "disabled")
                    ...
                    if ($(this).val() == "") {
                        ...
                        if (phoneIsServer1[0] == 1) {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data == 1) {
                                        $this.siblings("p").html("手机号可以使用").attr({
                                            "class": "correct"
                                        }).css({
                                            "color": corrCol[0]
                                        });
                                        ...
                                        $this.siblings("p").html("手机号已被使用").removeAttr("class").css({
                                            "color": errCol[0]
                                        });
                                        if (isPhoneCode[0] == 1) {
                                            myform.find(phoneCodeBtn).css("color", codeBtnCol1[0]).attr("disabled", "disabled")
                ...
                yzm: function() {
                    ...
                    if (isPhoneCode[0] == 1) {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data == "1") {
                                        ...
                                        $this.siblings("p").html("验证码错误").removeAttr("class").css({
                                            "color": errCol[0]
                                        })
                                    } else if (data == "-1") {
                                        $this.siblings("p").html("验证码已过期").removeAttr("class").css({
                                            "color": errCol[0]
                                        })
                                    }
                                },
                        ...
                        myform.find(phoneCodeInput).siblings("p").html("√").attr({
                            "class": "correct"
                        }).css({
                            "color": corrCol[0]
                        })
                ...
                name1: function() {
                    ...
                    if (Tsval == "") {
                        ...
                        $(this).siblings("p").removeAttr("class").css({
                            "color": errCol[0]
                        }).html("请输入" + NameMinLength[0] + "至" + NameMaxLength[0] + "位字符的用户名")
                    } else {
                        if (nameIsserver[0] == 1) {
                            var $this = $(this);
                            var vl = Tsval;
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data == 1) {
                                        $this.siblings("p").html("用户名可以注册").attr({
                                            "class": "correct"
                                        }).css({
                                            "color": corrCol[0]
                                        })
                                    } else {
                                        $this.siblings("p").html("用户名已被注册").removeAttr("class").css({
                                            "color": errCol[0]
                                        })
                                    }
                                },
                ...
                password: function() {
                    ...
                    if ($(this).val() != mypasswords.val() && mypasswords.val() != "") {
                        mypasswords.siblings("p").removeAttr("class").css({
                            "color": errCol[0]
                        }).html("两次输入的密码不一致")
                ...
                name2: function() {
                    ...
                    if (Tsval == "") {
                        ...
                        $(this).siblings("p").html("请输入" + NameMinLength2[0] + "至" + NameMaxLength2[0] + "位字符的昵称").removeAttr("class").css({
                            "color": errCol[0]
                        })
                    } else {
                        $(this).siblings("p").html("√").attr({
                ...
                Reqds: function() {
                    ...
                    if (Tsval == "") {
                        $(this).siblings("p").removeAttr("class").css({
                            "color": errCol[0]
                        }).html(RequiredsTps[reqtps.index($(this).parent())])
                    ...
                    if ($(this).val() == "") {
                        ...
                        if (mailboxIsServer[0] == 1) {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data == 1) {
                                        $this.siblings("p").html("邮箱可以注册").attr({
                                            "class": "correct"
                                        }).css({
                                            "color": corrCol[0]
                                        });
                                        ...
                                        $this.siblings("p").html("邮箱已被注册").removeAttr("class").css({
                                            "color": errCol[0]
                                        });
                ...
                vform: function() {
                    if (myform.find(Required).length >= 1) {
                        for (var i = 0; i < myform.find(Required).length; i++) {
                            if (myform.find(Required).eq(i).val() == "") {
                                myform.find(Required).eq(i).siblings("p").removeAttr("class").css({
                                    "color": errCol[0]
                                }).html(RequiredTps[0])
                            }
                        }
                    ...
                    if (myform.find(Requireds).length >= 1) {
                        for (var j = 0; j < myform.find(Requireds).length; j++) {
                            if (myform.find(Requireds).eq(j).val() == "") {
                                myform.find(Requireds).eq(j).siblings("p").removeAttr("class").css({
                                    "color": errCol[0]
                                }).html(RequiredsTps[j])
                            }
                        }
                    ...
                    if (isPhoneCode[0] == 1) {
                        if (phoneCodeInput.val() == "") {
                            phoneCodeInput.siblings("p").removeAttr("class").css({
                                "color": errCol[0]
                            }).html("请输入验证码")
                    ...
                    if (mymailbox.val() == "") {
                        console.log(mymailbox.val());
                        mymailbox.siblings("p").removeAttr("class").css({
                            "color": errCol[0]
                        }).html("请输入芝麻分")
                    ...
                    if (mypassword.val() == "") {
                        mypassword.siblings("p").removeAttr("class").css({
                            "color": errCol[0]
                        }).html("请输入密码")
            ...
            Required.on("blur keyup",
            function() {
                valiform.Reqd.apply($(this))
            });
            Requireds.on("blur keyup",
            function() {
                valiform.Reqds.apply($(this))
            });
            myname1.on("blur keyup",
            function() {
                valiform.name1.apply($(this))
            });
            myname2.on("blur keyup",
            function() {
                valiform.name2.apply($(this))
            });
            myphone1.on("blur keyup",
            function() {
                valiform.vphone1.apply($(this))
            });
            myphone.on("blur keyup",
            function() {
                valiform.vphone.apply($(this))
            });
            phoneCodeBtn.on("click",
            function() {
                valiform.msg.apply($(this))
            });
            phoneCodeInput.on("blur keyup",
            function() {
                valiform.yzm.apply(phoneCodeInput)
            });
            if (isPhoneCode[0] == 1) {
            ...
            mymailbox.on("blur keyup",
            function() {
                valiform.mailbox.apply($(this))
            });
            myCard.on("blur keyup",
            function() {
                valiform.card.apply($(this))
            });
            mypassword.on("blur keyup",
            function() {
                valiform.password.apply($(this))
            });
            mypasswords.on("blur keyup",
            function() {
                valiform.passwords.apply($(this))
            });
            myCode.on("blur keyup",
            function() {
                valiform.codes.apply($(this))
            });
            myform.on("click", mybtn,
            function() {
